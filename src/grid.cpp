...
/* ----------------------------------------------------------------------
   Setup grid values for implicit surface generation from explicit
   explicit surface. Namely, corner (corners of grid group) and
   xyzsize (size of lowest level cell - must be uniform). igroup
   is the grid group (can be all)
------------------------------------------------------------------------- */
void Grid::set_impgrid(int igroup, double *corner, double *xyzsize)
{
