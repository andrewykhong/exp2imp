...
if dim < 2 or dim > 3:
	print("Dim needs to be either 2 or 3")
	sys.exit()
if nx < 3 or ny < 3:
	print("Number of cells in x- and y- direction must be greater than 3")
	sys.exit()
if dim == 2 and nz != 1:
	print("2D but Nz not equal to 1")
	sys.exit()
if dim == 3 and nz < 3:
	print("Number of cells in z- direction must be greater than 3")
